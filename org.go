...
func (c *Client) GetOrgSites(orgID string) ([]Site, error) {
...
func (c *Client) CountOrgTickets(orgID string) (map[TicketStatus]int, error) {
...
func (c *Client) CountOrgAlarms(orgID string) (map[string]int, error) {
